"""
SVIPro Metadata Management Module
...
Example usage:
    ...
    ...     description="Sampling protocol for urban study"
    ... )
    >>>
    >>> # Validate metadata
...
from svipro.metadata.models import (
    SamplingMetadata,
...
from svipro.metadata.serializer import (
    MetadataSerializer,
    MetadataBatchSerializer
)

from svipro.metadata.validator import (
    MetadataValidator,
    MetadataValidationError,
    quick_validate
)

from svipro.metadata.exporter import (
    MetadataExporter
)
