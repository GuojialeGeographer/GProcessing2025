...
from ssp.metadata.models import SamplingMetadata
from ssp.metadata.serializer import MetadataSerializer
...
<head>
    ...
    <title>SpatialSamplingPro Sampling Protocol Report</title>
    <style>
...
<body>
    <h1>📍 SpatialSamplingPro Sampling Protocol Report</h1>
"""
...
"""
        ...
        ssp_version = execution.get('ssp_version', '0.1.0') if isinstance(execution, dict) else '0.1.0'
        html += f"""
    <div class="footer">
        <p>Generated by SpatialSamplingPro v{ssp_version}</p>
