"""
Simple test script for performance module (without parallel processing).
"""
import sys
...
print("\nNote: Parallel processing test skipped (requires if __name__ == '__main__')")
